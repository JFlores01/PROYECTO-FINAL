...
const dni = document.getElementById('equipo');
...
function checkInputs() {
    ...
    const equipoValue = equipo.value.trim();
    ...
    if (equipoValue === '') {
        setError(equipo, 'Por favor, rellene el campo');
        verdadero = false;
    } else if (!isDNI(equipoValue)) {
        setError(equipo, 'Ingrese un equipo de la competición');
        verdadero = false;
    } else {
        setSuccesFor(equipo);
    }
